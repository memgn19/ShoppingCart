...
<head>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
    ...
    <symbol id="home" viewBox="0 0 16 16" style="color: black;">
...
<body class="bg-body">
  ...
  <div class="container">
    <div class="d-flex flex-wrap align-items-center justify-content-between">
      <!-- Contenedor para logo y título alineados a la izquierda -->
      <div class="d-flex align-items-center me-auto">
        ...
        <h3 class="ms-3 mt-1 title text-black">Shopping Cart</h3>
          ...
          <ul id="header" class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
            <li>
              <a href="index.php" class="nav-link text-black pt-4">
            ...
            <li>
              <form action="" method="post">
                <button class="btn" type="submit" name="action" value="sessionDestroy">
    ...
    <div class="px-3 py-2 mb-3">
      <div class="container d-flex flex-wrap justify-content-center position-relative">
        ...
        <form class="col-12 col-lg-auto mb-2 mb-lg-0 me-lg-auto" role="search">
          <input id="search" type="search" name="search" class="form-control ms-3" placeholder="Search..." aria-label="Search" value="<?php if (isset($_GET['search'])) {
                                                                                                                            echo $_GET['search'];
                                                                                                                          } ?>">
        </form>
        ...
        <div class="text-end">
          ...
          <button type="button" id="button2" onclick="desplegarRegistrar()" class="btn btn-styles">Sign-up</button>
          <button type="button" id="button1" onclick="desplegar()" class="btn btn-styles me-2">Login</button>
  ...
  <main class="min-vh-100">
    ...
    ?>
    <div id="products" class="album py-5 ">
      <div class="container">
